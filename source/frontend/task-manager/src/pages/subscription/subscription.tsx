        ...
        return (
          <div className="" key={key}>
            <Card
              ...
              style={{
                borderImageSource:
                  "linear-gradient(to bottom, #A1A1A1 0%, #818181 43%, #3B3B3B 100%)",
                borderImageSlice: 3,
              }}
            >
              ...
              <span className="mb-4 text-xl font-medium text-white/90">
                {plan.taskAmount}
              </span>
              ...
              <Link to={`${plan.link}`} onClick={handleButtonClick}>
                <Button
                  ...
                  className={`p-5 transition-all duration-300 ease-in-out hover:scale-105 ${
                    isCurrentPlan
                      ? "cursor-not-allowed bg-gray-500 opacity-50"
                      : "hover:cursor-pointer hover:bg-[linear-gradient(to_bottom,#A1A1A1_0%,#818181_43%,#3B3B3B_100%)] hover:text-white"
                  }`}
                >
